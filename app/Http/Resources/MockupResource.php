...
class MockupResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'area_top' => $this->area_top, $this->area_top,
            'area_left' => $this->area_left, $this->area_left,
            'area_width' => $this->area_width, $this->area_width,
            'area_height' => $this->area_height, $this->area_height,
