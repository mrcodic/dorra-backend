...
class BundleCartService
{
    ...
    public function store(Request $request): Cart
    {
        return DB::transaction(function () use ($request) {
             ...
             *
             * Old flow:
             * - one config without quantity => full bundle item quantity.
             *
             * New flow:
             * - repeated same bundle_item_id with quantity per config.
             *
             * Important:
             * - if bundle item has custom price / price_id, only one config is allowed.
             */
    ...
    private function normalizeQuantityPriceDetails(
        ...
        /*
         * Product price option is package price.
         *
         * Example:
         * custom price = EGP 400 for quantity 20.
         * Unit product price = 400 / 20.
         */
