...
class StoreProductRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'specifications.*.specification_options' => ['nullable', 'array', 'min:1'],
            'specifications.*.specification_options.*.value_en' => 'nullable|string',
            'specifications.*.specification_options.*.value_ar' => 'nullable|string',
