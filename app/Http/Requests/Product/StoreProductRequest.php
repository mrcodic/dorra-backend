...
//                Rule::unique('products', 'name->ar'),
            ...
            'specifications.*.specification_options.*.price' => ['required_with:specifications', 'numeric', 'min:1'],
            'specifications.*.specification_options.*.option_image' => ['required_with:specifications', 'exists:media,id'],
