...
class UpdateCarouselRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'carousels.*.product_id' => ['required_without:category_id', 'integer', 'exists:products,id'],
            'carousels.*.category_id' => ['required_without:product_id', 'integer', 'exists:categories,id'],
