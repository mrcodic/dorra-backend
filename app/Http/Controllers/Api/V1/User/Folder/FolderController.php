...
use App\Http\Requests\Folder\{StoreFaqRequest, StoreInventoryRequest, UpdateFaqRequest, UpdateInventoryRequest};
...
class FolderController extends Controller
{
    ...
    public function index()
    {
        ...
        return Response::api(data: FolderResource::collection($folders->load(['designs.owner', 'designs.designable'])));
    }
