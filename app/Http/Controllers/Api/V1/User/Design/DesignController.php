...
class DesignController extends Controller
{
    ...
    {
        $design = $this->designService->showResource($design, ['media', 'designable','designable.prices','designable.specifications.options','dimension','template.types','specifications']);
