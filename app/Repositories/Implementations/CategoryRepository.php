...
class CategoryRepository extends BaseRepository implements CategoryRepositoryInterface
{
    ...
    public function all(bool $paginate = false, $columns = ['*'], $relations = [], $orderBy = 'created_at', $direction = 'desc', $filters = [], $perPage = 10, $counts = []): EloquentCollection|LengthAwarePaginator
    {
