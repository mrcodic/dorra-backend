...
const dt_user_table = $(".code-list-table").DataTable({
    ...
    order: [[1, "asc"]],
    dom: '<"row d-none"<"col"B>>t<"d-flex flex-column flex-md-row justify-content-between align-items-center px-2 pb-1"<"text-muted"i><"pagination"p>>',
    buttons: [
        {
            extend: "excel",
            text: "Export",
...
function updateBulkDeleteVisibility() {
    ...
    $("#selected-count-text").text(
        `${selectedCount} Discount Code${
            selectedCount > 1 ? "s are" : " is"
        } selected`
    );
