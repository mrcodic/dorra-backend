...
var dt_user_table = $(".order-list-table").DataTable({
    ...
    columns: [
        ...
        },
        {
            ...
            <span class="badge bg-secondary">${row.order_items_count > 1 ?row.order_items_count:'' }</span>
        </div>`,
        }
        { data: "order_number" },
        { data: "user_name" },
        ...
        { data: "total_price" },
        {
            ...
            <div class="d-flex align-items-center gap-1 " style="background-color: #FCF8FC;border-radius: 12px ;padding: 4px 8px">
                <img src="${row.status.icon}" alt="${row.status.label}" style="width: 20px; height: 20px;">
