...
Route::put('/{template}/mockups/{mockup}/positions',[TemplateController::class,'savePositionsAndUploadMockups']);
Route::put('/{template}/mockups/{mockup}/image',[TemplateController::class,'uploadTemplateImage']);
