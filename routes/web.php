...
Route::middleware(AutoCheckPermission::class)->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.', 'controller' => OrderController::class,], function () {
            ...
            Route::get('/order-items/{orderItem}/production-file/{variant?}', 'downloadProductionFile')
                ->where('variant', 'original|colored')
        ...
        Route::group(['prefix' => 'templates', 'as' => 'templates.', 'controller' => TemplateController::class,], function () {
            Route::get('/tableau-create', 'tableauCreate')->name('tableau-create');
            Route::get('/search', 'search')->name('search');
            Route::post('/bulk-delete', 'bulkDelete')->name('bulk-delete');
            Route::post('/landing', 'addToLanding')->name('landing');
            Route::post('/landing/remove-category', 'removeFromLanding')->name('landing.remove');
        ...
        Route::delete('ai-categories/studio-items/{studioItem}/quick-delete', [AiCategoryController::class, 'quickDeleteStudioItem'])
            ->name('ai-categories.studio-items.quick-delete');
    ...
    Route::prefix('api/v1/')->group(function () {
        ...
        Route::post('templates/{template}/mockups/{mockup}/detach',[TemplateController::class,'detachMockup']);
