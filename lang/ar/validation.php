...
return [
    ...
    */
    'custom' => [
        'state_id' => [
            ...
            'integer'  => 'يجب اختيار محافظة صالحة.',
            'exists'   => 'المحافظة المختارة غير موجودة.',
        ],

        'city_id' => [
            'required' => 'يرجى اختيار المدينة.',
            'integer'  => 'يجب اختيار مدينة صالحة.',
            'exists'   => 'المدينة المختارة غير موجودة.',
        ],

        'user_id' => [
            'required' => 'يرجى اختيار المستخدم.',
            'integer'  => 'يجب اختيار مستخدم صالح.',
            'exists'   => 'المستخدم المختار غير موجود.',
        ],

        'product_id' => [
            'required' => 'يرجى اختيار المنتج.',
            'integer'  => 'يجب اختيار منتج صالح.',
            'exists'   => 'المنتج المختار غير موجود.',
        ],

        'order_id' => [
            'required' => 'يرجى اختيار الطلب.',
            'integer'  => 'يجب اختيار طلب صالح.',
            'exists'   => 'الطلب المختار غير موجود.',
        ],

        'addresses.*.city_id' => [
            'required' => 'يجب أن يحتوي كل عنوان على مدينة صالحة مختارة.',
            'exists'   => 'المدينة المختارة غير صالحة.',
        ],
        'addresses.*.label' => [
  ...
  */
    ...
    'attributes' => [
        ...
        'addresses.*.label' => 'تسمية العنوان',
        'addresses.*.line' => 'سطر العنوان',
        'addresses.*.state_id' => 'محافظة العنوان',
        'addresses.*.city_id' => 'مدينة العنوان',
    ],
];
