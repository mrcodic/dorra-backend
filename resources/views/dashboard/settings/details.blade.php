            ...
            <div id="tab2" class="tab-section">
                ...
                <div class="social-repeater">
                    <form action="{{ route("social-links") }}" method="post" id="socialForm">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <select class="form-select" name="platform">
                                                ...
                                                @foreach(\App\Enums\Setting\SocialEnum::cases() as $socialEnum)
                                                    <option
                                                        value="{{ $socialEnum->value }}" @selected($socialEnum == $socialLink->platform)>{{ $socialEnum->label() }}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="col-8">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="url" class="form-control"
                                                           placeholder="yourpage.com" value="{{ $socialLink->url }}"/>
                                                </div>
                                            </div>
                                            <div class="col-4 d-flex align-items-end">
                                                <button type="button" class="btn btn-outline-danger delete-social"
                                                        data-repeater-delete>Delete
                                                </button>
                                    ...
                                    <div id="social-media-group" class="row social-input-row">
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <select class="form-select" name="platform">
                                                ...
                                                @foreach(\App\Enums\Setting\SocialEnum::cases() as $socialEnum)
                                                    <option
                                                        value="{{ $socialEnum->value }}">{{ $socialEnum->label() }}</option>
                                                @endforeach
                                            </select>
                        ...
                        <button type="button" class="btn btn-outline-primary mb-2 mt-2" id="add-social"
                                data-repeater-create>+ Add Social Media
                        </button>
                ...
                <form class="profileSettingsForm" method="post" action="{{ route('settings-edit-details') }}">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="order_format" id="prefix" value="{{ setting('order_format') }}"
                                   class="form-control" placeholder="e.g. ORD-"/>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end mt-2">
                        <button class="btn btn-outline-secondary me-1" type="reset">Discard Changes</button>
