        ...
        <div class="tab-content flex-grow-1 p-1" id="v-pills-tabContent">
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="card p-1 mb-4 border rounded-md shadow-sm">
                                        <form action="{{ route('carousels.update') }}" method="POST"
                                            ...
                                            <input type="hidden" name="carousels[{{ $loop->index }}][id]"
                                                value="{{ $carousel->id }}">
                                            ...
                                            <small class="text d-block mb-1">Recommended: 375×672 px, max 2 MB</small>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select name="product_id" class="form-select">
                                                    ...
                                                    <option value="{{ $product->id }}" {{ $carousel->product_id ==
                                                        $product->id ? 'selected' : '' }}>
                                                        {{ $product->name }}
                                                    </option>
                                                    @endforeach
                            ...
                            <div data-repeater-item>
                                <div class="col-md-12 mb-2">
                                    <div class="card p-2 mb-4 border rounded shadow-sm">
                                        <form action="{{ route('carousels.update', null) }}" method="POST"
                                            enctype="multipart/form-data" class="carousel">
                                            @csrf
                                            @method("PUT")
                                            <div class="website-media-ids"></div>
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="card p-4 mb-4 border rounded shadow-sm">
                                    <form method="POST" action="{{ route('carousels.update') }}"
                                        ...
                                        <label class="form-label">Website Image</label>
                                        <div class="dropzone website-dropzone"></div>
                                        <small class="text d-block mb-1">Recommended: 1920*520 px, max 2 MB</small>
                                        <div class="upload-wrapper">
                                            <div class="uploaded-image d-none mt-2">
                                                <img src="" class="img-fluid rounded"
                                                    style="width: 50px; height: 50px; object-fit: cover;">
                                        ...
                                        <label class="form-label mt-1">Mobile Image</label>
                                        <div class="dropzone mobile-dropzone"></div>
                                        <small class="text-muted d-block mb-1">Recommended: 375×672 px, max 2 MB</small>
                                        <div class="upload-wrapper">
                                            <div class="uploaded-image d-none mt-1">
                                                <img src="" class="img-fluid rounded"
                                                    style="width: 50px; height: 50px; object-fit: cover;">
                                            </div>
                                            <div class="progress upload-progress d-none">
            ...
            <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                <div class="card d-flex flex-row align-items-center justify-content-between p-1 mb-2"
                    ...
                    <!-- Toggle Switch -->
                    <form id="categorySectionForm" action="{{ route('landing-sections.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input toggle-switch" type="checkbox" id="categorySectionToggle" {{
            ...
            <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                <div class="card d-flex flex-row align-items-center justify-content-between p-1 mb-2"
                    ...
                    <form id="productSectionForm" action="{{ route('landing-sections.update') }}" method="POST">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input toggle-switch" type="checkbox" id="productSectionToggle" {{
            ...
            <div class="tab-pane fade" id="tab5" role="tabpanel" aria-labelledby="tab5-tab">
                ...
                <div class="card d-flex flex-row align-items-center justify-content-between p-1 mb-1"
                    ...
                    <form id="statisticsSectionForm" action="{{ route('landing-sections.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input toggle-switch" type="checkbox" id="statisticsSectionToggle"
            ...
            <div class="tab-pane fade" id="tab7" role="tabpanel" aria-labelledby="tab7-tab">
                ...
                <div class="card d-flex flex-row align-items-center justify-content-between p-1 mb-2"
                    ...
                    <form id="testimonialSectionForm" action="{{ route('landing-sections.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input toggle-switch" type="checkbox" id="testimonialSectionToggle"
                                        ...
                                        <div class="p-1 d-flex">
                                            <div>
                                                ...
                                                <small class="text-muted">{{
                                                    \Carbon\Carbon::parse($review->date)->format('d/m/Y') }}</small>
                                                <p class="mb-1">{{ $review->review }}</p>
                                                <form class="remove-review" action="{{ route(" reviews.remove",
                                                    $review->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
            ...
            <div class="tab-pane fade" id="tab8" role="tabpanel" aria-labelledby="tab8-tab">
                <div class="card d-flex flex-row align-items-center justify-content-between p-1 mb-1"
                    ...
                    <form id="partnerSectionForm" action="{{ route('landing-sections.update') }}" method="POST">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input toggle-switch" type="checkbox" id="partnerSectionToggle" {{
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1">
                                    <div class="p-2 d-flex flex-row align-items-center justify-content-between"
                                        style="box-shadow: 0px 4px 6px 0px #4247460F; border-radius: 10px;">
                                        <!-- Image -->
                                        <img src="{{ $partner->getUrl() }}" alt="Product" class="me-3 rounded"
                                            style="width: 80px; height: 80px; object-fit: cover;">

                                        <!-- Remove Button -->
                                        <form id="remove-partner" action="{{ route('partners.remove',$partner->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
