...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click.accordion', '.category-list-table tbody tr:not(.details-row)', function(e) {
        ...
        function initAccordion() {
            if ($(window).width() <= 768) {
                $('.category-list-table tbody tr:not(.details-row)').each(function() {
                    const $row = $(this);
                    ...
                    const subCreditOrders = $row.find('td:nth-child(4)').html() || '';
                        ...
                        <td colspan="4">
                            <div class="details-content">
                                <div class="detail-row">
                                    <span class="detail-label">SubCredit Orders:</span>
                                    <span class="detail-value">${subCreditOrders}</span>
                                </div>
                                <div class="detail-row">
        ...
        // On DataTable events
        $(document).on('draw.dt', '.category-list-table', function () {
        ...
        function updateBulkDeleteVisibility() {
            ...
            if (count > 0) {
                $('#selected-count-text').text(`${count} Product${count > 1 ? 's are' : ' is'} selected`);
