            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex flex-column">
                    <div class="d-flex flex-column gap-1">
                        ...
                        <div class="d-flex align-items-center gap-1">
                            <img src="{{ $model->jobEvents->last()?->admin?->image->getUrl() ?: asset('/images/admin-avatar.png') }}" alt="Admin avatar">
                            <div class="d-flex flex-column">
                    ...
                    <div class="d-flex flex-column gap-1">
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-1 justify-content-between">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <img  class="img-fluid rounded" style="max-height:200px" src="{{$model->orderItem->itemable->getImageUrlForType($type->value->label())}}" alt="item photo">
                            </div>
                            @endforeach
                        </div>
                    </div>
