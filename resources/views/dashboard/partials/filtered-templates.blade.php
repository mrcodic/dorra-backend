            ...
            <div class="dropdown position-absolute top-0 end-0 m-1">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="actionDropdown{{ $template->id }}">
                    ...
                    <form class="change-status-form"
                          action="{{ route('product-templates.change-status.show',$template->id) }}"
                          method="post">
                        @csrf
                        @method("PUT")
                    ...
                    <li>
                        <form class="change-status-form" action="{{ route('product-templates.change-status.show',$template->id)
                        }}" method="post">
                            @csrf
                            @method("PUT")
