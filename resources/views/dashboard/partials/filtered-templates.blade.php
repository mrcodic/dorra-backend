        ...
        @can('product-templates_delete')
            ...
            <div class="dropdown position-absolute top-0 end-0 m-1">
                ...
                <ul class="dropdown-menu dropdown-menu-end"
                    aria-labelledby="actionDropdown{{ $template->id }}">
                    ...
                    @can('product-templates.change-status.draft_show')
                        <li>
                            <form class="change-status-form"
                                ...
                                <button class="dropdown-item change-status-btn w-100"><i data-feather="file"
                                                                                         class="me-1"> </i>Draft
                                </button>
                            </form>
                        </li>
            ...
            <div style="background-color: #F4F6F6;height:200px;border-radius:12px;padding: 15px;"
                 class="d-flex justify-content-center align-items-center">                 <!-- Top Image --> <img
                    ...
                    alt="Template Image"></div> <!-- Template Info -->
            <div class="card-body text-start p-2">
                <div><h6 class="fw-bold mb-1 text-black fs-3"
                         style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; max-width: 300px; height: 54px;">                         {{ $template->getTranslation('name', app()->getLocale()) }}                     </h6>
                    <!-- Info Row -->
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <div><p style="display:inline; margin-right: 10px">
                                Type:</p>
...
@empty
    <div class="d-flex flex-column justify-content-center align-items-center text-center py-5 w-100"
         style="min-height:65vh;">         <!-- Empty Image --> <img src="{{ asset('images/Empty.png') }}"
                                                                     alt="No Templates" style="max-width: 200px;"
                                                                     class="mb-2">          <!-- Empty Message --> <p
            class="mb-2 text-secondary">Nothing to show yet.</p></div>
@endforelse
