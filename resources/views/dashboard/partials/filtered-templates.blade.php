@forelse ($data as $template)
    <div class="col-md-6 col-lg-4 col-xxl-4 custom-4-per-row"
        ...
        <div class="position-relative"
             style="box-shadow: 0px 4px 6px 0px #4247460F;
            ...
            <!-- Editor Badge (LEFT) -->
            <span class="badge position-absolute top-0 start-0 ms-4 mt-1"
                  style="
            ...
            <div class="dropdown position-absolute top-0 end-0 m-1">
                <button class="btn btn-sm border-0"
                        type="button"
                        id="actionDropdown{{ $template->id }}"
                        data-bs-toggle="dropdown"
                        aria-expanded="false"
                        style="background-color:#F9FDFC">
                    ...
                    @can('product-templates_update')
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('product-templates.edit',$template->id) }}">
                    ...
                    @can('product-templates.change-status.live_show')
                        <li>
                            <form class="change-status-form"
                                ...
                                <input type="hidden"
                                       name="status"
                                       value="{{ \App\Enums\Template\StatusEnum::LIVE }}">
                                <button class="dropdown-item w-100">
            ...
            <div class="d-flex justify-content-center align-items-center"
                 style="background-color:#F4F6F6;height:200px;border-radius:12px;padding:15px;">
                <img src="{{ $template->getFirstMediaUrl('templates')
            ...
            <div class="card-body text-start p-2">
                ...
                <h6 class="fw-bold mb-1 fs-3 text-black"
                    style="
                        display:-webkit-box;
                        -webkit-line-clamp:2;
                ...
                <div class="mb-1">
                    ...
                    @foreach($template->types as $type)
                        <span class="badge text-light p-75 px-2"
                ...
                <!-- Dates -->
                <div class="mb-1">
                    <p>Created at: {{ $template->created_at->format('d/m/Y') }}</p>
                    <p>Last update: {{ $template->updated_at->format('d/m/Y') }}</p>
                </div>

                <!-- Tags -->
                <div class="d-flex flex-wrap gap-1 mb-1" style="min-height:44px;">
                    @foreach($template->tags as $tag)
                        <span style="background-color:#FCF8FC;padding:8px;border-radius:8px;">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge p-75 px-2"
                          style="
                              background-color: {{ $template->status->bgHex() }};
