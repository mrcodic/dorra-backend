        ...
        <div class="card-body text-start p-2">
            <div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-1">
                    <div style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 300px;height:29px">{{ $mockup->product->name }}
                    </div>
            ...
            <div class="d-flex justify-content-around p-2">
                ...
                <button  class="btn  btn-outline-danger open-delete-mockup-modal"
                        ...
                        data-bs-target="#deleteMockupModal"> <i data-feather="trash-2"></i> Delete</button>
            </div>
...
<div class="d-flex flex-column justify-content-center align-items-center text-center py-5 w-100"
    ...
    <!-- Empty Message -->
    <p class="mb-2 text-secondary">You didn’t create any mockups yet.</p>
