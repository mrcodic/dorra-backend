                            ...
                            <div class="flex-grow-1">
                                <div class="">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-6 form-group mb-2">
                                            <label for="mockupsSelect"
                                                   class="label-text mb-1">Mockups</label>
                                            <select id="mockupsSelect" class="form-select select2"
                                                    name="mockup_ids[]" multiple>
                                            </select>
                                        </div>
                                    </div>
            ...
            function fetchMockups() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        const current = $mockups.val() || [];

                        $mockups.empty();

                        items.forEach(function (mockup) {
                            $mockups.append(
                                $('<option>', {
                                    value: mockup.id,
                                    text: mockup.name ?? ('Mockup #' + mockup.id),
                                    'data-img': mockup.images.front.base_url
                                })
                            );
                        });

                        $mockups
                            .val(current.filter(v => $mockups.find('option[value="'+v+'"]').length))
                            .trigger('change');
                    },
                    error: function (xhr) {
