                ...
                <div class="card-body ">
                    ...
                    <div class="d-flex gap-1 rounded p-1 mb-2" style="border: 1px solid #CED5D4">
                        ...
                        <div class="d-flex flex-column gap-1">
                            ...
                            <p style="color: #424746">When the checkbox is selected, the product can be added directly
                                to the cart without
                                customization. If it’s not selected, the product must be customized before being added
                                to cart.</p>
                        </div>
                    </div>
