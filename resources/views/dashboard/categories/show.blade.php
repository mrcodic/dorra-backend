...
<div class="row">
    <div class="col-md-4 bg-white p-2 rounded">
        ...
        <div class="w-100 d-flex justify-content-center">
            <img id="mainPreview" src="{{$model->getFirstMediaUrl('categories') }}" alt="Preview" class="img-fluid mb-2"
        ...
        <!-- Edit Button -->
        <div class="text-end">
            <a href="{{ route('categories.edit',$model->id) }}" class="btn btn-primary">Edit</a>
        </div>
    </div>
