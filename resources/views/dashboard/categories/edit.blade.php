                                            ...
                                            <div class="mb-2 d-flex align-items-center gap-2">
                                                ...
                                                <div class="form-check form-switch">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" id="download_production_file"
                                                        ...
                                                        @checked($model->download_production_file == 1) />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-2 d-flex align-items-center gap-2">
                                                ...
                                                <div class="form-check form-switch">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" id="allowed_color_palettes"
                                                        ...
                                                        @checked($model->allowed_color_palettes == 1) />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        const multiDropzone = new Dropzone("#multi-dropzone", {
            ...
            init: function () {
                ...
                // ✅ Show existing images if editing
                    ...
                    @foreach($model->getMedia('category_extra_images')->filter(fn ($media) => ! $media->hasCustomProperty('color_hex'))  as $media)
                {
                    const multiMockFile = {
