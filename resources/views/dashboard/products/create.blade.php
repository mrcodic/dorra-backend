                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="product-name" class="form-control" name="name" placeholder="Product Name"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea name="description" id="product-description" class="form-control" placeholder="Product Description"></textarea>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" name="name" class="form-control" placeholder="Specification Name"/>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div data-repeater-list="specification_options">
                                                                        <div data-repeater-item>
                                                                            <div class="row d-flex align-items-end mt-2">
                                                                                <div class="col-md-4">
                                                                                    <label>Value</label>
                                                                                    <input type="text" name="specification_options[][value]" class="form-control" placeholder="Value"/>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <label>Price</label>
                                                                                    <input type="text" name="specification_options[][price]" class="form-control" placeholder="Price"/>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <label>Image</label>
                                                                                    <input type="file" name="specification_options[][image]" class="form-control"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <button type="button" class="btn btn-icon btn-primary mt-2" data-repeater-create>
                                                                                <i data-feather="plus" class="me-25"></i> <span>Add Value</span>
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                </div>
