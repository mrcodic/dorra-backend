...
<section id="multiple-column-form">
    <div class="row">
        <div class="col-12">
                            ...
                            <div class="col-md-12">
                                <div class="mb-1">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-center justify-content-md-start gap-2"
                                        ...
                                        <div class="form-check option-box rounded border py-1 d-flex justify-content-center align-items-center"
                                            style="width: 100px">
                                            <input class="form-check-input me-1" type="checkbox" name="dimensions[]"
                                                id="dimension-checkbox-{{ $dimension['id'] }}"
                                                value="{{ $dimension['id'] }}"
                                                @checked($model->dimensions->contains($dimension->id))
                                            />
                        ...
                        <div class="mb-1">
                            ...
                            <div class="row gap-1 d-flex flex-column flex-md-row" style="margin: 2px;">
                                <div class="col border rounded-3 p-1">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="has_custom_prices"
                                            id="customPrice" value="1" @checked($model->has_custom_prices == 1)
                                        @disabled($model->has_custom_prices == 0)>
                                        <div>
                                            <label class="form-check-label label-text d-block" for="customPrice">Add
                                                Quantity Manually</label>
                                ...
                                <div class="col border rounded-3 p-1">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input " type="radio" name="has_custom_prices"
                                            id="defaultPrice" value="0" @checked($model->has_custom_prices ==
                                        0)@disabled($model->has_custom_prices == 1)>
                                        <div>
                                            <label class="form-check-label label-text d-block" for="customPrice">Default
                                                Quantity</label>
                                            ...
                                            <div class="row d-flex align-items-end">
                                                <div class="col-md-4">
                                                    <div class="mb-1">
                                                        ...
                                                        <input type="number" name="quantity"
                                                            value="{{ $price->quantity }}" class="form-control"
                                                            placeholder="Add Quantity" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                    ...
                    <div class="col-md-12" id="default-price-section"
                        ...
                        <div class="mb-1">
                            <label class="form-label label-text" for="base_price">Original Price (EGP)
                                (Per
                                Item)</label>
                            <input type="text" id="base_price" name="base_price" value="{{ $model->base_price }}"
            ...
            >>>>>>> a99c3a92a1626433fa947d94b7033f4df1297ece
        </div>
        </form>
