        ...
        <div class="card-datatable table-responsive pt-0">
            ...
            <div id="bulk-delete-container" class="my-2 bulk-delete-container" style="display: none;">
                ...
                <div class="delete-container d-flex flex-wrap align-items-center justify-content-center justify-content-md-between"
                    style="z-index: 10;">
                    <p id="selected-count-text">0 Industries are selected</p>
                    <button type="submit" id="delete-selected-btn" data-bs-toggle="modal"
                        data-bs-target="#deleteIndustriesModal"
                    ...
                    <form style="display: none;" id="bulk-delete-form" method="POST"
                        action="{{ route('industries.bulk-delete') }}">
                        @csrf
                        <button type="submit" id="delete-selected-btn" data-bs-toggle="modal"
                            data-bs-target="#deleteIndustriesModal"
                            class="btn btn-outline-danger d-flex justify-content-center align-items-center gap-1 delete-selected-btns open-delete-categories-modal">
            ...
            'formId' => 'deleteIndustryForm',
            'title' => 'Delete Industry',
            ])
            @include('modals.delete',[
            'id' => 'deleteIndustriesModal',
            'formId' => 'bulk-delete-form',
            'title' => 'Delete Industries',
            'confirmText' => 'Are you sure you want to delete this items?',
            ])
            @include('modals.industries.add-industry')
            @include('modals.industries.show-industry')
            @include('modals.industries.edit-industry')
...
<script>
    const industriesDataUrl = "{{ route('industries.data') }}";
