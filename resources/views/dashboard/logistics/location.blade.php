...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .location-list-table th:nth-child(5) {
            display: none !important;
        }

        .location-list-table tbody tr:not(.details-row) td:nth-child(5) {
            display: none !important;
        }
        ...
        .location-list-table tbody tr:not(.details-row) td:nth-child(1) {
            position: relative;
...
<script>
    ...
    $(document).on('click.accordion', '.location-list-table tbody tr:not(.details-row)', function(e) {
    ...
    function initAccordion() {
        if ($(window).width() <= 768) {
            $('.location-list-table tbody tr:not(.details-row)').each(function() {
                const $row = $(this);
...
$(document).ready(function() {
    ...
    $(document).off('click.accordion').on('click.accordion', '.location-list-table tbody tr:not(.details-row)', function(e) {
