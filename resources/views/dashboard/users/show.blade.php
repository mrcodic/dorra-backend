    ...
    <section class="app-user-view-account">
                                    ...
                                    $order->total_price }}</p>
                                            ...
                                            @foreach($order->orderItems->sortByDesc('created_at') as $item)
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <div class="d-flex align-items-start gap-2">
                                                        ...
                                                        <div>
                                                            <div
                                                                class="text-black fss-16">{{ $item->itemable?->name }}</div>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('orders.show',$order->id) }}"
                                               class="btn btn-primary mb-1">Show
                                                Order</a>
                                        </div>
                                        ...
                                        <div class="review-wrapper" data-review-id="{{ $review->id }}">
                                            <div class="d-flex align-items-center gap-1 mb-2">
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        class="fw-bold text-dark fs-4">{{ $review->reviewable?->name }}</div>
                                                </div>
                                            </div>
                                            ...
                                            d-none" :""}}" data-review-id="{{ $review->id }}">
                                                ...
                                                <button
                                                    class="btn btn-primary reply-btn  {{$review->comment ? " d-none" :""}}"
                                        ...
                                        <div class="reply-block {{$review->comment ? "" :" d-none"}}">
                                            ...
                                            <div class="d-flex gap-2 justify-content-end">
                                                ...
                                                <button class="btn btn-outline-secondary delete-reply"
                                                        data-review-id="{{ $review->id }}">Delete Reply
                                                </button>
                                            </div>
                                        </div>
                                        <!-- Divider -->
        ...
        <div class="modal modal-slide-in new-user-modal fade" id="modals-slide-in">
            <div class="modal-dialog">
                <form id="replyForm" class="add-new-user modal-content pt-0" method="post"
