...
@section('content')
    <section class="app-user-view-account " style="height: 100vh;">
        <div class="row h-100"> <!-- User Sidebar -->
            <div class="col-xl-4 col-lg-5 col-md-5 order-1 order-md-0 h-100"> <!-- User Card -->
                            ...
                            <div class="tab-pane fade show active" id="tab1">
                                <form action="{{ route("users.update",$model->id) }}" id="editUserForm" method="post">
                                    ...
                                    <div class="d-flex gap-1 justify-content-end mt-2">
                                        ...
                                        <button type="submit"
                                                class="btn btn-primary  place-order fs-16 saveChangesButton"
                                ...
                                @forelse($model->teams as $team)
                                    <div class="d-flex justify-content-between align-items-end ">
                                        ...
                                        <div class="d-flex gap-1 justify-content-end mt-2">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary place-order fs-16"
                                                    data-bs-toggle="modal" data-bs-target="#teamAccessModal" data-team-id="{{ $team->id }}">
                                                Show
                                            </button>
