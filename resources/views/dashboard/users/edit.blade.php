...
@section('vendor-style')
    {{-- Page Css files --}} <link rel="stylesheet" href="{{ asset(mix('vendors/css/forms/select/select2.min.css')) }}"> <link rel="stylesheet" href="{{ asset(mix('vendors/css/animate/animate.min.css')) }}"> <link rel="stylesheet" href="{{ asset(mix('vendors/css/extensions/sweetalert2.min.css')) }}"> <link rel="stylesheet" href="{{ asset(mix('vendors/css/tables/datatable/dataTables.bootstrap5.min.css')) }}"> <link rel="stylesheet" href="{{ asset(mix('vendors/css/tables/datatable/responsive.bootstrap5.min.css')) }}"> <link rel="stylesheet" href="{{ asset(mix('vendors/css/tables/datatable/buttons.bootstrap5.min.css')) }}"> <link rel="stylesheet" href="{{ asset(mix('vendors/css/tables/datatable/rowGroup.bootstrap5.min.css')) }}">
@endsection

@section('page-style')
    {{-- Page Css files --}} <link rel="stylesheet" href="{{ asset(mix('css/base/plugins/forms/form-validation.css')) }}"> <link rel="stylesheet" href="{{ asset(mix('css/base/plugins/extensions/ext-component-sweet-alerts.css')) }}">
@endsection

@section('content') <section class="app-user-view-account " style="height: 100vh;"> <div class="row h-100"> <!-- User Sidebar --> <div class="col-xl-4 col-lg-5 col-md-5 order-1 order-md-0 h-100"> <!-- User Card --> <div class="card h-100"> <div class="card-body">
                         ...
                         text-center d-flex justify-content-center align-items-center"
                            ...
                            {{ $model->status == "Active" ? "Active" : "Blocked" }}</span>
                                ...
                                <input class="form-check-input" type="checkbox" id="account_status"
                                       name="status"  {{ $model->status === "Active" ? "checked" : "" }}>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card h-100">
                <div class="card-body">
                    <ul class="nav nav-tabs border-bottom-0">
                        <li class="nav-item">
                            <a class="nav-link active custom-tab" data-bs-toggle="tab" href="#tab1">Account
                                Information</a>
                        </li>
                            ...
                            <form action="{{ route("users.update",$model->id) }}" id="editUserForm" method="post">
                                ...
                                <div class="d-flex align-items-center justify-content-between ">
                                    <img
                                        ...
                                        alt="User avatar"/>
                                    <div>
                                        <button type="button" class="btn bg-white text-danger fs-5 remove-old-image" data-image-id="{{$model->image?->id }}">Remove Photo</button>

                                        <button type="button" class="btn btn-outline-secondary fs-5" id="changePhotoBtn">
                                            Change Photo
                                        </button>
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="first_name" value="{{ $model->first_name }}" name="first_name" class="form-control"
                                               placeholder="Enter first name" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="last_name" class="form-label label-text ">Last Name</label>
                                        <input type="text" id="last_name" value="{{ $model->last_name }}" name="last_name" class="form-control"
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="email" id="email" value="{{ $model->email }}" name="email" class="form-control"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="tel" id="phone_number" value="{{ $model->phone_number }}" name="phone_number" class="form-control"
                        ...
                        <div class="tab-pane fade" id="tab2">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-1">
                                <div class="">
                                    ...
                                    <span
                                        class="fs-16">Receive email whenever something requires your attention</span>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="mobileNotifToggle">
                                </div>
...
@section('vendor-script')
    {{-- Vendor js files --}} <script src="{{ asset(mix('vendors/js/forms/select/select2.full.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/forms/cleave/cleave.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/forms/cleave/addons/cleave-phone.us.js')) }}"></script> <script src="{{ asset(mix('vendors/js/forms/validation/jquery.validate.min.js')) }}"></script>
    {{-- data table --}} <script src="{{ asset(mix('vendors/js/extensions/moment.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/jquery.dataTables.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/dataTables.bootstrap5.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/dataTables.responsive.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/responsive.bootstrap5.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/datatables.buttons.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/jszip.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/pdfmake.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/vfs_fonts.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/buttons.html5.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/buttons.print.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/tables/datatable/dataTables.rowGroup.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/extensions/sweetalert2.all.min.js')) }}"></script> <script src="{{ asset(mix('vendors/js/extensions/polyfill.min.js')) }}"></script>
@endsection
