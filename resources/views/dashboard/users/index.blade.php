                                    ...
                                    <div data-repeater-item class="row g-2 mb-4 align-items-end border p-2 rounded">
                                        <div class="col-md-10">
                                            ...
                                            <input type="text" name="label" id="addresses.*.label"
                                                   class="form-control mb-1" placeholder="Enter Address Label"/>
                                            <input type="text" name="line" id="addresses.*.line"
                                                   class="form-control mb-1" placeholder="Enter Address Line"/>
    ...
    <script>
        $(document).ready(function () {
            ...
            function updateBulkDeleteVisibility() {
                ...
                if (count > 0) {
                    $('#selected-count-text').text(`${count} User${count > 1 ? 's' : ''} are selected`);
