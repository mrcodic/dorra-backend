        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive pt-0">
                <div class="d-flex justify-content-between align-items-center gap-1 px-1">
                    ...
                    <button type="date" class="btn btn-outline-secondary fs-16 px-1" style="width: 126px;" >Auto Generate</button>
                    <button type="button" class="btn btn-outline-primary fs-16" data-bs-toggle="modal" data-bs-target="#addAdminModal">
                    Create New Code
                    </button>
                </div>
