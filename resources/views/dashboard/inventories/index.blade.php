...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .inventory-list-table tbody tr:not(.details-row) {
            cursor: pointer;
            transition: background-color 0.2s ease;
        }

        /* Add expand indicator to the role column */
        .inventory-list-table tbody tr:not(.details-row) td:nth-child(1) {
            position: relative;
...
<div class=" card p-1">
    ...
    <section class="app-user-list">
        ...
        <div class="card">
            ...
            <script>
                const inventoriesDataUrl = "{{ route('inventories.data') }}";

            </script>

            {{-- Page js files --}}
            <script src="{{ asset('js/scripts/pages/app-inventory-list.js') }}?v={{ time() }}"></script>
