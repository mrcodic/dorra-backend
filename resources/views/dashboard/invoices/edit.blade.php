        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control" value="{{ $model->user?->first_name }}" name="name"
                        value="John Doe" readonly>
                </div>
                <div class="mb-1">
                    <label class="form-label fw-bold">Email</label>
                    <input type="email" class="form-control" value="{{ $model->user?->email }}" name="email"
                        value="john@example.com" readonly>
                </div>
                <div class="mb-1">
                    <label class="form-label fw-bold">Phone</label>
                    <input type="text" class="form-control" value="{{ $model->user?->phone_number }}" name="phone"
            ...
            <div class="col-12 col-md-8">
                ...
                <form id="discount-code-form" action="{{ route('orders.apply-discount-code') }}" method="post">
                    ...
                    <div id="discount-code-error" class="invalid-feedback d-block text-danger mt-1"
                        style="display: none;"></div>
                    <div id="discount-code-success" class="valid-feedback d-block text-success mt-1"
                        style="display: none;"></div>
                </form>
