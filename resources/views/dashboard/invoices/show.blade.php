            ...
            {{-- <div class="col-md-4">--}}
                ...
                {{-- <div class="form-check mb-1">--}}
                    {{-- <input class="form-check-input" type="radio" name="invoice_status"
                        id="status_{{ $status->value }}" --}} {{-- value="{{ $status->value }}"
                        style="transform: scale(1.5); margin-right: 10px;" {{--}} {{-- old('invoice_status',
                        $model->invoice_status->value ?? 2) == $status->value ? 'checked' : '' }}>--}}
