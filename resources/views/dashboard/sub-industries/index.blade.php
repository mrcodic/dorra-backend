...
@section('title', 'Sub industries List')
@section('main-page', 'Sub industries')
...
<section class="app-user-list">
    ...
    <div class="card">
        ...
        <div class="card-datatable table-responsive pt-0">
            ...
            'id' => 'deleteSubIndustryModal',
            'formId' => 'deleteSubIndustryForm',
            'title' => 'Delete Industry',
            ])
            @include('modals.delete',[
            'id' => 'deleteSubIndustriesModal',
...
<script>
    const subIndustriesDataUrl = "{{ route('sub-industries.data') }}";
