...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .permissions-list-table tbody tr:not(.details-row) {
            cursor: pointer;
            transition: background-color 0.2s ease;
        }

        /* Add expand indicator to the role column */
        .permissions-list-table tbody tr:not(.details-row) td:nth-child(1) {
            position: relative;
            ...
            <div class="px-1 d-flex flex-wrap justify-content-between align-items-center gap-1">
                <form action="" method="get" class="flex-grow-1 me-1 col-12 col-md-5 position-relative">
                    ...
                    <input type="text" class="form-control ps-5 border rounded-3" name="search_value"
                        id="search-permission-form" placeholder="Search here" style="height: 38px;">
                ...
                <input type="date" class="form-control border rounded-3 col-12 col-md-2"
                    style="width: 120px; height: 38px;" />

                <a class="btn btn-outline-primary col-12 col-md-2" href="" data-bs-toggle="modal"
...
<script>
    ...
    $(document).on('click.accordion', '.permissions-list-table tbody tr:not(.details-row)', function(e) {
    ...
    function initAccordion() {
        if ($(window).width() <= 768) {
            $('.permissions-list-table tbody tr:not(.details-row)').each(function() {
                const $row = $(this);
    ...
    // On DataTable events
    $(document).on('draw.dt', '.permissions-list-table', function () {
...
$(document).ready(function() {
    ...
    $(document).off('click.accordion').on('click.accordion', '.permissions-list-table tbody tr:not(.details-row)', function(e) {
