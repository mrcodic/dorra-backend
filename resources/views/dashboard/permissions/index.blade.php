    ...
    <div class="card">
        ...
        <div class="card-datatable table-responsive pt-0">
            <div class="d-flex justify-content-between align-items-center gap-1 px-1">
                ...
                <a class="btn btn-outline-primary ms-2" href="{{ route('categories.create') }}">Add New Permission</a>
            </div>
            <table class="permisions-list-table table mt-2">
...
{{-- Page js files --}}
{{-- <script src="{{ asset('js/scripts/pages/app-permisions-list.js') }}?v={{ time() }}"></script>--}}
@endsection