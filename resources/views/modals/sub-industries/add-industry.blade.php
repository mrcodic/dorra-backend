<div class="modal modal-slide-in new-user-modal fade" id="addSubIndustryModal">
    <div class="modal-dialog">
        <div class="add-new-user modal-content pt-0">
            <form id="addSubIndustryForm" enctype="multipart/form-data" action="{{ route('sub-industries.store') }}">
                @csrf
...
<script !src="">
    handleAjaxFormSubmit("#addSubIndustryForm", {
        successMessage: "Sub Industry added Successfully",
        onSuccess: function () {
            location.reload()
        }
    })
