<div class="modal modal-slide-in new-user-modal fade" id="autoGenerateCodeTemplateModal">
        ...
        <div class="add-new-user modal-content pt-0">
            <form id="addTagForm" enctype="multipart/form-data" action="{{ route('tags.store') }}">
                ...
                <div class="modal-header mb-1">
                    <h5 class="modal-title" id="exampleModalLabel">Auto generate discount code</h5>
                </div>
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="number" id="numberOfCodes" class="form-control" placeholder="Enter number of generated codes here">
                    </div>
