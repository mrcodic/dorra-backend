<div class="modal modal-slide-in new-user-modal fade" id="addIndustryModal">
    <div class="modal-dialog">
        <div class="add-new-user modal-content pt-0">
            <form id="addIndustryForm" enctype="multipart/form-data" action="{{ route('industries.store') }}">
                @csrf
...
<script !src="">
    handleAjaxFormSubmit("#addIndustryForm",{
        successMessage:"Industry added successfully",
        onSuccess:function () {
            location.reload()
        }
    })
