        ...
        <div class="add-new-user modal-content pt-0">
                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="mb-2" id="shippingMethodSection">
                        ...
                        <div class="d-flex flex-column flex-md-row gap-1">
                            <div class="col-md-6 form-check border rounded-3 p-1 px-3">
                    ...
                    @php
                    $shippingAddressId = $model->OrderAddress->firstWhere('shipping_address_id', '!=',
            ...
            <form id="addAddressForm" class="row gy-1 gx-2" method="post"
                ...
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control" placeholder="Choose Address Label" id="add-category-name-en"
                        name="label" />
