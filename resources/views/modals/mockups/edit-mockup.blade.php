...
{{--                                   placeholder="Mockup Name" value="{{$mockup->name}}">--}}
{{--                        </div>--}}
{{--                        <!-- Mockup Type -->--}}
{{--                        <div class="form-group mb-2">--}}
...
{{--                                                @checked($mockup->types->pluck('id')->contains($type->id))--}}
{{--                                            >--}}
...
{{--                                    <option value="{{ $product->id }}" @selected($product->id == $mockup->product->id)>--}}
