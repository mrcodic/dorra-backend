      ...
      <div class="modal-body pb-5 px-sm-5 pt-50">
        ...
        <form id="editUserForm" class="row gy-1 pt-75" method="post" action="{{ route('users.update',['user'=> $user])
          ...
          <div class="col-12 col-lg-6">
            ...
            <input type="text" id="modalEditUserFirstName" name="first_name" class="form-control" placeholder="John"
              value="{{ $user->first_name }}" data-msg="Please enter your first name" />
          </div>
          <div class="col-12 col-lg-6">
            <label class="form-label" for="modalEditUserLastName">Last Name</label>
            <input type="text" id="modalEditUserLastName" name="last_name" class="form-control" placeholder="Doe"
              value="{{ $user->last_name }}" data-msg="Please enter your last name" />
          </div>
          ...
          <div class="col-12 col-lg-6">
            ...
            <div class="input-group">
              ...
              <!-- Phone Number Input -->
              <input type="text" id="phone_number" class="form-control dt-contact" placeholder="(609) 933-44-22"
