                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="form-control auto-resize" id="question-en" placeholder="Write your question here(En)" name="description[en]" disabled>Who are we?</textarea>
                        </div>
                        <div class="col-6">
                            <label class="form-label label-text">Question (AR)</label>
                            <textarea class="form-control auto-resize" id="question-ar" placeholder="Write your question here(Ar)" name="description[ar]" disabled></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="form-control auto-resize" id="answer-en" placeholder="Enter Answer(En)" name="description[en]" disabled>Based in Cairo, Egypt, with a market presence since 2003. The company specializes in on-demand digital printing
...
reliable solutions tailored to the unique needs of businesses.</textarea>
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="form-control auto-resize" id="answer-ar" placeholder="Enter Answer(Ar)" name="description[ar]" disabled></textarea>
                        </div>
                    </div>
