<div class="modal modal-slide-in new-user-modal fade" id="wditLocationModal">
        ...
        <div class="add-new-user modal-content pt-0">
            <form id="locations" method="post" enctype="multipart/form-data" action="{{ route('logistics.store') }}">
                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="mb-1">
                        <label for="editAddressLink" class="form-label">Address Link</label>
                    ...
                    <div class="mb-1">
                        <label for="editDays" class="form-label">Select Available Days</label>
