            ...
            <form id="addDiscountForm" method="post" enctype="multipart/form-data" action="{{ route('discount-codes.store') }}">
                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="mb-1">
                        ...
                        <select class="select2 form-select" id="availableDays" name="available_days[]" multiple>
                    ...
                    <div class="mb-1">
                        ...
                        <select class="select2 form-select" id="availableTime" name="available_times[]" multiple>
